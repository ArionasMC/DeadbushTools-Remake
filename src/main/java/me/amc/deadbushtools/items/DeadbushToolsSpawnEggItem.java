...
public class DeadbushToolsSpawnEggItem extends SpawnEggItem
{
     protected static final List<DeadbushToolsSpawnEggItem> UNADDED_EGGS = new ArrayList<>();
     private final Lazy<? extends EntityType<?>> entityTypeSupplier;


     public DeadbushToolsSpawnEggItem(final RegistryObject<? extends EntityType<?>> entitySupplier, int primaryColorIn,
     ...
     public static void initSpawnEggs()
     {
          final Map<EntityType<?>, SpawnEggItem> EGGS = ObfuscationReflectionHelper.getPrivateValue(SpawnEggItem.class, null,
                  "field_195987_b"); // was "EGGS" but threw an error
